import { AttachmentEntity, Post } from '@connectingmatrix/orm/repositories/entities';
import { ingestSource, type IngestionRuntimeHooks } from '@giga/tree/services/post/ingestion';
import type { IngestAttachmentInput } from '@giga/shared/types/contracts/post.types';
import type { SupabaseClient } from '@supabase/supabase-js';

export async function ingestAttachment(supabase: SupabaseClient, input: IngestAttachmentInput, runtime?: IngestionRuntimeHooks) {
